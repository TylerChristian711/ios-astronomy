...
class PhotosCollectionViewController: UIViewController {
    ...
    private func loadImage(forCell cell: ImageCollectionViewCell, forItemAt indexPath: IndexPath) {
        ...
        if cache.contains(photoReference.id) {
            ...
            let photoFetchPeration = FetchPhotoOperation(reference: photoReference)
            fetchOperationsDictionary[photoReference.id] = photoFetchPeration
            let cacheOperation = BlockOperation {
                guard let data = photoFetchPeration.imageData else { return }
            ...
            cacheOperation.addDependency(photoFetchPeration)
            updateUIOperation.addDependency(photoFetchPeration)
            
            photoFetchQueue.addOperations([photoFetchPeration, cacheOperation], waitUntilFinished: false)
